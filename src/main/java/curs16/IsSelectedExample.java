...
public class IsSelectedExample extends BaseTest {
	 ...
	 * 
	 * isSelected() --> verifica daca un element de tip checkbox sau radio button este selected sau nu
	 * se aplica doar pt elem care au atributul type = checkbox sau radio button
	 * 
